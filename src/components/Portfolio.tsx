...
export function Portfolio() {
  ...
  return (
    <div id="portfolio" className="mt-64 relative">
      <div className="flex items-center justify-between mb-20 px-4 max-w-7xl mx-auto">
        ...
        >
          Recent <span className="text-gray-200">Works</span>
        </motion.h2>
              ...
              >
                <div className="relative aspect-[3/4] rounded-[3rem] overflow-hidden bg-gray-100 mb-8 shadow-2xl">
                  ...
                  <div className="absolute top-8 left-8 right-8 flex justify-between items-start">
                    <span className="text-white font-display text-2xl">{project.id}</span>
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                    ...
                    <div className="flex gap-2">
                      {project.tags.map(tag => (
                        <span key={tag} className="bg-white text-black px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider">
                          {tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className={`flex items-center justify-between px-4 transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0'}`}>
                  <span className="text-gray-400 font-medium uppercase tracking-widest text-xs">{project.category}</span>
